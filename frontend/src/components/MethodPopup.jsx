  ...
  return (
    ...
    >
      <motion.div
        ...
        className="bg-[#0f1018] border border-[#1d1e2c] rounded-xl max-w-lg w-full shadow-2xl flex flex-col max-h-[85vh]"
        onClick={e => e.stopPropagation()}
      >
        {/* Header */}
        <div className="flex items-start justify-between gap-4 px-5 py-4 border-b border-[#1d1e2c] bg-[#0a0b14] shrink-0">
          ...
          <button
            ...
            className="p-1.5 rounded hover:bg-white/5 text-slate-600 hover:text-slate-300 transition-colors shrink-0"
          >
            <X className="w-4 h-4" />
          </button>
        </div>
                ...
                return (
                  ...
                  >
                    ...
                    {isRecommended && !isSelected && (
                      <span className="text-[9px] font-black uppercase tracking-wider text-blue-400/50 shrink-0 mt-0.5 hidden sm:inline">
                        Recommended
                      </span>
                    )}
                  </motion.button>
        ...
        {/* Footer actions */}
        <div className="px-4 sm:px-5 py-3 sm:py-4 border-t border-[#1d1e2c] bg-[#0a0b14] flex flex-wrap gap-2 shrink-0">
          <button
            onClick={handleCancel}
            className="w-full sm:w-auto px-3.5 py-2.5 sm:py-2 rounded-lg font-bold text-xs uppercase tracking-wider bg-white/5 hover:bg-white/10 border border-white/8 text-slate-500 hover:text-slate-300 transition-colors"
          >
            Cancel
          </button>
          <button
            onClick={handleAuto}
            className="flex-1 flex items-center justify-center gap-1.5 px-3.5 py-2.5 sm:py-2 rounded-lg font-bold text-xs uppercase tracking-wider bg-white/5 hover:bg-white/10 border border-white/8 text-slate-500 hover:text-slate-300 transition-colors"
          >
            <Zap className="w-3.5 h-3.5" />
            <span className="hidden sm:inline">Auto </span>Select
          </button>
          <button
